...
class resnext101_32x4d_rcnn_dcn_context(Symbol):
    ...
    def get_symbol(self,cfg,is_train = True):
        ...
        origin_roi_pool = mx.symbol.ROIPooling(
            name='origin_roi_pool', data=conv_new_1_relu, rois=rois, pooled_size=(7, 7), spatial_scale=0.0625)
        merge_roi_pool = mx.sym.Concat(deformable_roi_pool,origin_roi_pool,name='concat_roipooling')

        # 2 fc
        fc_new_1 = mx.symbol.FullyConnected(name='fc_new_1', data=merge_roi_pool, num_hidden=1024)

...
class resnet_v1_101_rcnn_fpn_final(Symbol):
    def __init__(self):
        """
        ...
        self.anchor_size = [None,None,32,64,128,256,256]
        self.feat_stride = [0,2,4,8,16,16]
    ...
    def get_resnet_v1_conv4(self, data):
        ...
        return res2c_relu,res3b3_relu,res4b22_relu
    ...
    def get_resnet_v1_conv5(self, conv_feat):
        ...
        return res5c_relu
    def get_fpn(self,data):
        res2c_relu,res3b3_relu,res4b22_relu  = self.get_resnet_v1_conv4(data)
        res5c_relu = self.get_resnet_v1_conv5(res4b22_relu)
        P5 = mx.symbol.Convolution(name = 'P5',data = res5c_relu,num_filter = 256,kernel = (1,1),stride=(1,1))
        C4_lateral = mx.symbol.Convolution(name = 'C4_lateral',data = res4b22_relu,num_filter = 256,kernel = (1,1),stride = (1,1))
        #C5_topdown = mx.symbol.UpSampling(name = 'C5_topdown',data = P5,num_filter = 256,scale= 2,sample_type = 'bilinear',num_args = 2)
        C5_topdown = mx.contrib.symbol.Bilinear(name = 'C5_topdown',data = P5,target = C4_lateral,has_target_tensor = True)
        P4_pre = mx.symbol.broadcast_add(name = 'P4_pre',*[C4_lateral,C5_topdown])
        P4 = mx.symbol.Convolution(name = 'P4',data = P4_pre,num_filter=256,kernel = (3,3),stride = (1,1),pad = (1,1))
        C3_lateral = mx.symbol.Convolution(name = 'C3_lateral',data = res3b3_relu,num_filter = 256,kernel = (1,1),stride = (1,1))
       # C4_topdown = mx.symbol.UpSampling(name = 'C4_topdown',data = P4,num_filter = 256,scale= 2,sample_type = 'bilinear',num_args = 2)
        C4_topdown = mx.contrib.symbol.Bilinear(name = 'C4_topdown',data = P4,target = C3_lateral,has_target_tensor = True)
        P3_pre = mx.symbol.broadcast_add(name = 'P3_pre',*[C3_lateral,C4_topdown])
        P3 = mx.symbol.Convolution(name = 'P3',data = P3_pre,num_filter=256,kernel = (3,3),stride = (1,1),pad = (1,1))
        C2_lateral = mx.symbol.Convolution(name = 'C2_lateral',data = res2c_relu,num_filter = 256,kernel = (1,1),stride = (1,1))
       #C3_topdown = mx.symbol.UpSampling(name = 'C3_topdown',data = P3,num_filter = 256,scale= 2,sample_type = 'bilinear',num_args = 2)
        C3_topdown = mx.contrib.symbol.Bilinear(name = 'C3_topdown',data = P3,target = C2_lateral,has_target_tensor = True)
        P2_pre = mx.symbol.broadcast_add(name = 'P2_pre',*[C2_lateral,C3_topdown])
        P2 = mx.symbol.Convolution(name = 'P2',data = P2_pre,num_filter=256,kernel = (3,3),stride = (1,1),pad = (1,1))
        return P2,P3,P4,P5
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        P2,P3,P4,P5 = self.get_fpn(data)

        rpn_cls_score, rpn_bbox_pred = self.get_rpn(P4, num_anchors)
        ...
        conv_new_1 = mx.sym.Convolution(data=P4, kernel=(1, 1), num_filter=256, name="conv_new_1")
    ...
    def init_weight_rcnn(self, cfg, arg_params, aux_params):
        arg_params['C4_lateral_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['C4_lateral_weight'])
        arg_params['C4_lateral_bias'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['C4_lateral_bias'])
        #arg_params['C3_lateral_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['C3_lateral_weight'])
        #arg_params['C3_lateral_bias'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['C3_lateral_bias'])
        #arg_params['C2_lateral_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['C2_lateral_weight'])
        #arg_params['C2_lateral_bias'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['C2_lateral_bias'])

        arg_params['P5_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['P5_weight'])
        arg_params['P5_bias'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['P5_bias'])
        arg_params['P4_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['P4_weight'])
        arg_params['P4_bias'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['P4_bias'])
